...
import { idlFactory } from './research_ai_simple_backend.did.js';
export { idlFactory } from './research_ai_simple_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_RESEARCH_AI_SIMPLE_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./research_ai_simple_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the research_ai_simple_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./research_ai_simple_backend.did.js")._SERVICE>}
 */
export const research_ai_simple_backend = createActor(canisterId);
